...
#'
#' @param model The picked sfpca model
#' @param data: The prepared data from prepare_data() function
#' @return A list after post hoc rotation (need change)
post_hoc_rotation <- function(sfpca_data, model){
  ...
  #rename Q
  li <- list(num_subjects = N, npcs = K, nknots = model$knot, Q = Q, alpha_new = alpha_new,
