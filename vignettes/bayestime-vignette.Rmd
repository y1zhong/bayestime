...
plot_mean_curve(output = model_output, original = T, x_lab = 'age', y_lab = 'shannon', ymin=0, ymax=7.6)
#dev.off()
plot_mean_curve(output = model_output, original = F, x_lab = 'age', y_lab = 'shannon')
```

## plot_fpc_curve(): 
```{r, fig.height = 4, fig.width=6}
d <- plot_fpc_curve(output = model_output, pc_idx = c(1,2,3), original = T)
d <- plot_fpc_curve(output = model_output, pc_idx = c(2,3), original = F, x_tick = c(2,5))
```
...
d <- plot_fpc_group_mean(output = model_output, pc_idx = 2, original = F, group_name = 'diet_3')
```
