...
plot_group(data = ECAM, time_name = 'month_of_life', response_name = 'shannon',
           unique_subject_id = 'studyid', group_name = invars[1])
```
...
## plot_fpc_curve(): 
```{r}
plot_fpc_curve(data = ECAM, response_name = 'shannon', basis = model_basis, 
               output = model_output, rotation = model_rotation)
```
